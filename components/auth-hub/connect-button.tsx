...
export function ConnectButton({ clientSlug, dsId, status }: ConnectButtonProps) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="group relative mt-4 flex w-full items-center justify-center gap-2 overflow-hidden rounded-[100px] bg-white px-5 py-2.5 text-sm font-bold text-black transition-all hover:bg-transparent disabled:opacity-50"
    >
